    ...
    <form method="POST" id="frmCoupons" name="frmCoupons" action="change-status-coupons-promotions">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">List Promotions Coupons</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">List Promotions Coupons</h3>
                        </div>
                                ...
                                <table id="bannerTable" class="table table-bordered table-striped">
                                    ...
                                    @foreach ($coupons as $coupon)
                                        <tr>
                                            ...
                                            <td> <a href="/administrator/list-coupon-customers/{{$coupon->id}}">{{$couponsUsers[$coupon->id]}}</a></td>

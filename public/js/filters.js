$(document).ready(function() {
        ...
        k.forEach(function(key){
            ...
            if(wrap.length){
                ...
                selected.forEach(function(s){
                    //$('input[value="'+s+'"]',wrap)[0].checked=true;
    ...
    function applyFilter(el){
        var that=$(el),group=that.parents('.checkList'),label=that.parents('.widget')[0].dataset.filterType;
    ...
    // $('input[class="filter-field"]').change(function () {
    //     applyFilter(this);
    // });
    ...
    // $(document).on("change", 'input[class="filter-field-brand"]', function() {
    //     applyFilter(this);
    // });

    $(document).on('change', '.filter-field-brand', function() {
        applyFilter(this);
    });

    // $('input[class="categories"]').change(function () {
    //     applyFilter(this);
    // });
    ...
    // $('input[class="subCategories"]').change(function () {
    //     applyFilter(this);
    // });

...
<head>
    ...
    <![endif]-->
    <title> Sportsdrive:Your one time password for registration</title>
                    ...
                    <tr>
                        <td align="center" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="oneColumn" style="background-color: rgb(255, 255, 255); box-shadow: rgb(216, 216, 216) 0px 0px 10px;"><tbody>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-top:20px;padding-bottom:5px;padding-left:20px;padding-right:20px" class="title"><h2 class="bigTitle" style="color:#313131;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:26px;font-weight:600;font-style:normal;letter-spacing:normal;line-height:34px;text-align:center;padding:0;margin:0">One Time Password</h2></td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" style="padding-bottom:20px;padding-left:20px;padding-right:20px" class="infoDate">
                                        <p style="color: #444444;font-family: 'Open Sans',Helvetica,Arial,sans-erif;    font-size: 14px;font-weight: 400;line-height: 22px;padding: 0;margin: 0;">Dear {{$userData['first_name']}}, </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" style="padding-bottom:20px;padding-left:20px;padding-right:20px" class="infoDate">
                                        <p style="color: #444444;font-family: 'Open Sans',Helvetica,Arial,sans-erif;    font-size: 14px;font-weight: 400;line-height: 22px;padding: 0;margin: 0;">Thank you for your interest in Sports Drive!</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" style="padding-bottom:20px;padding-left:20px;padding-right:20px" class="infoDate">
                                        <p style="color: #444444;font-family: 'Open Sans',Helvetica,Arial,sans-erif;    font-size: 14px;font-weight: 400;line-height: 22px;padding: 0;margin: 0;">Last 3 digits of OTP : {{$otp}}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" style="padding-bottom:20px;padding-left:20px;padding-right:20px" class="infoDate">

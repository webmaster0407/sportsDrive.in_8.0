...
<![endif]-->
<title> Sportsdrive:Order Confirmation</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="wrapperTable" style="width:700px">
		<tbody>
			<tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="wrapperTable" style="width:700px">
    ...
    font-family: 'Open Sans',Helvetica,Arial,sans-serif;font-size: 15px;font-weight: 600;font-style: normal;    letter-spacing: normal;line-height: 26px;padding: 0;margin: 0;">Shipping Address :</h4>
									<p style="color: #444444;font-family: 'Open Sans',Helvetica,Arial,sans-erif;    font-size: 16px;font-weight: 400;line-height: 22px;padding: 0;margin: 0;"><strong>{{$shipping_address_details->address_title}}</strong><br></p>
									<p style="color: #444444;font-family: 'Open Sans',Helvetica,Arial,sans-erif;    font-size: 14px;font-weight: 400;line-height: 22px;padding: 0;margin: 0;">{{$shipping_address_details->full_name}}<br>
										{{$shipping_address_details->address_line_1}}<br>
										{{$shipping_address_details->address_line_2}}<br>
										{{$shipping_address_details->city}}{{"-".$shipping_address_details->pin_code}}<br>
									    {{$shipping_address_details->state}}<br>
										{{$shipping_address_details->country}}<br>
										{{"Phone - ".$shipping_address_details->contact_no}}
									</p>
								</td>
    ...
    font-family: 'Open Sans',Helvetica,Arial,sans-serif;font-size: 15px;font-weight: 600;font-style: normal;    letter-spacing: normal;line-height: 26px;padding: 0;margin: 0;">Billing Address :</h4>
										<p style="color: #444444;font-family: 'Open Sans',Helvetica,Arial,sans-erif;    font-size: 16px;font-weight: 400;line-height: 22px;padding: 0;margin: 0;"><strong>{{$billing_address_details->address_title}}</strong><br></p>
									    <p style="color: #444444;font-family: 'Open Sans',Helvetica,Arial,sans-erif;    font-size: 14px;font-weight: 400;line-height: 22px;padding: 0;margin: 0;">{{$billing_address_details->full_name}}<br>
										{{$billing_address_details->address_line_1}}<br>
										{{$billing_address_details->address_line_2}}<br>
										{{$billing_address_details->city}}{{"-".$billing_address_details->pin_code}}<br>
									    {{$billing_address_details->state}}<br>
										{{$billing_address_details->country}}<br>
										{{"Phone - ".$billing_address_details->contact_no}}</p>
								</td>
								</tr>
								</table>
								</td>
											 ...
											 <tr>
												...
												<td width="50px" style="color:#444444;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:13px;font-weight:600;font-style:normal;letter-spacing:normal;line-height:20px;padding:0px 5px;margin:0;background:#fff;"><a href="{{ url('/product/details/'.$val->product_slug) }}">{{$val->product_name}}</a>
													<div class="other-info">
														@if($val->color!=null)<p style="line-height:22px; font-size:13px;"><span style="color:#444444;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:22px;text-align:center;padding:0;margin:0;background:#fff;">Color:</span>{{$val->color}}</p>@endif
														@if($val->size!=null)<p style="line-height:22px; font-size:13px;"><span style="color:#444444;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:22px;text-align:center;padding:0;margin:0;background:#fff;">Size:</span>{{$val->size}}</p>@endif
														@if($val->sku!=null)<p style="line-height:22px; font-size:13px;"><span style="color:#444444;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:22px;text-align:center;padding:0;margin:0;background:#fff;">SKU:</span>{{$val->sku[0]}}</p>@endif
													</div>
												</td>
		...
		float: right;
		margin-right: 20px;"> {{number_format($order->sub_total+$order->discount+$order->coupon_discount,2)}}</span></p></td>
		...
		margin-right: 28px;">₹</span> <span style="display: inline-block;
		float: right;
		margin-right: 20px;">{{number_format($order->total_shipping_amount,2)}}</span> </p>	</td>
										...
										<tr>
											...
											<td width="20%" style="color:red;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:13px;font-style:normal;letter-spacing:normal;line-height:22px;padding:0;margin:0;background:#fff;text-align:right;"><p>Offer Discount</p></td>
		...
		margin-right: 28px;">- ₹</span><span style="display: inline-block;
		float: right;
		margin-right: 20px;"> {{(number_format($order->discount,2))}}</span></p></td>
										</tr>
										@endif
										@if($order->coupon_discount>0)
											<tr>
												<td width="15%" style="color:red;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:26px;padding:0;margin:0;background:#fff;"> </td>
												<td width="50px" style="color:red;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:13px;font-weight:600;font-style:normal;letter-spacing:normal;line-height:20px;padding:0px 5px;margin:0;background:#fff;"></td>
												<td width="20%" style="color:red;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:13px;font-style:normal;letter-spacing:normal;line-height:22px;padding:0;margin:0;background:#fff;text-align:right;"><p>Coupon Discount({{$order->coupon_code}})</p></td>
												<td width="20%" style="color:red;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:26px;padding:0;margin:0;background:#fff;padding-left: 20px;"><p><span style="display: inline-block;
		margin-right: 28px;">- ₹</span><span style="display: inline-block;
		float: right;
		margin-right: 20px;"> {{(number_format($order->coupon_discount,2))}}</span></p></td>
											</tr>
										@endif
										<tr>
		...
		margin-right: 28px;">₹</span> <span style="display: inline-block;
		float: right;
		margin-right: 20px;">{{number_format($order->total,2)}}</span></p>	</td>
						...
						<tr>
							...
							<tr>
								<td align="center" valign="top" style="padding-bottom:5px;padding-left:20px;padding-right:20px" class="btnCard"><table border="0" cellpadding="0" cellspacing="0" align="center"><tbody><tr><td align="center" style="background-color:#1e7ed0;padding-top:10px;padding-bottom:10px;padding-left:25px;padding-right:25px;border-radius:2px" class="postButton"><a href="{{ url('/order/list') }}" style="color:#fff;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:12px;font-weight:600;letter-spacing:1px;line-height:20px;text-transform:uppercase;text-decoration:none;display:block" target="{{ url('/order/list') }}">Manage Orders</a></td></tr></tbody></table></td>
							</tr>
							<tr>
								<td align="center" valign="top" style="padding-bottom:0px;padding-left:20px;padding-right:20px" class="infoDate"><p class="midText" style="color:#313131;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:11px;font-weight:700;line-height:20px;text-align:center;padding:0;margin:0">Payment Method :

        ...
        <table cellpadding="0" cellspacing="0" border="0" align="center" class="emailBody" width="600" style="min-width:600px;">
          ...
          <tr>
                <td valign="top" style="padding:0; text-align:center; background-color:#ffffff;outline-style: none;" class="emailWrapper">
                    ...
                    <tr>
                      <td valign="middle" style="font: 16px/1.35em Arial,Helvetica,Tahoma; color:#6d6e70; font-weight:bold; padding: 15px 20px 0 20px; text-align: left; background-color:#ffffff; outline-style: none">Dear {{$fname}}{{$lname}}, </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td valign="middle" style="font: 14px/1.35em Arial,Helvetica,Tahoma; color:#6d6e70; padding: 15px 20px 0 20px; text-align: left; background-color:#ffffff; outline-style: none; ">You are receiving this email because we received a forgot password request for <b> {{$email_address}} </b> account.<br/>

          ...
          <tr>
              <td valign="top" style="padding:0; text-align:center; background-color:#ffffff;outline-style: none;" class="emailWrapper">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td valign="middle" style="font: 16px/1.35em Arial,Helvetica,Tahoma; color:#6d6e70; font-weight:bold; padding: 15px 20px 0 20px; text-align: left; background-color:#ffffff; outline-style: none">Dear {{$first_name}}, </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td valign="middle" style="font: 14px/1.35em Arial,Helvetica,Tahoma; color:#6d6e70; padding: 15px 20px 0 20px; text-align: left; background-color:#ffffff; outline-style: none; ">Your password has been changed successfully.</td>
                    </tr>
                    <tr>
                      <td valign="middle" style="font: 14px/1.35em Arial,Helvetica,Tahoma; color:#6d6e70; padding: 15px 20px 0 20px; text-align: left; background-color:#ffffff; outline-style: none; ">To be able to sign in to your account, please click the following link:</td>
                    </tr>
                     
                    <tr>
                      <td valign="middle" style="font: 14px/1.35em Arial,Helvetica,Tahoma; color:#6d6e70; padding: 15px 20px 0 20px; text-align: left; background-color:#ffffff; outline-style: none; "><a href="{{env('DOMAIN_NAME')}}/login" style="color:#C00" target="_blank">Click Here</a></td>
                    </tr>

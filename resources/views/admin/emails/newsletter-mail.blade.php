...
/*      @media only screen and (max-device-width: 720px) and (orientation:portrait) {*/
        @media only screen and (max-width: 600px) { 
            ...
            .image_responsive{ width:100%!important; height:auto!important;}
        ...
        <table cellpadding="0" cellspacing="0" border="0" align="center" class="emailBody" width="600" style="min-width:600px;">
          ...
          <tr>
                <td valign="top" style="padding:0; text-align:center; background-color:#ffffff;outline-style: none;" class="emailWrapper">
                    ...
                    <tr>
                      <td valign="middle" style="font: 16px/1.35em Arial,Helvetica,Tahoma; color:#6d6e70; font-weight:bold; padding: 15px 20px 0 20px; text-align: left; background-color:#ffffff; outline-style: none">Dear Subscriber, </td>
                    </tr>
                    <tr>
                      <td valign="middle" style="font: 28px/1.35em Arial,Helvetica,Tahoma; color:#57c0b8; font-weight:normal; padding: 15px 20px 0 20px; text-align: left; background-color:#ffffff; outline-style: none">{{$newslettersdata->newsletter_name}}</td>
                    </tr>
                    <tr>
                        <td valign="middle" style="font: 14px/1.35em Arial,Helvetica,Tahoma; color:#6d6e70; padding: 15px 20px 0 20px; text-align: left; background-color:#ffffff; outline-style: none; ">{!!$newslettersdata->newsletter_desc!!}</td>
                    </tr>
                    <tr>
                ...
                <td valign="top" style="padding:0; text-align:center; background-color:#89d3cd;outline-style: none; ">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableFooter">
                        ...
                        <td valign="top" align="center" style="padding:10px 0 0">
                                            <table width="150" border="0" cellspacing="0" cellpadding="0" class="tableSocial">
                                                <tr>
                                                    ...
                                                    <td valign="top" align="center" style="padding:5px"><a href="{{$siteDetails->facebook_url}}" title="Facebook"><img src="{{{URL::asset('images/facebook.jpg')}}}" width="32" height="32" alt="Facebook" /></a></td>
                                                    @endif
                                                    @if($siteDetails->twitter_url!=null)
                                                    <td valign="top" align="center" style="padding:5px"><a href="{{$siteDetails->twitter_url}}" title="Twitter"><img src="{{{URL::asset('images/twitter.jpg')}}}" width="32" height="32" alt="Twitter" /></a></td>
                                                    @endif
                                                    @if($siteDetails->instagram_url!=null)
                                                    <td valign="top" align="center" style="padding:5px"><a href="{{$siteDetails->instagram_url}}" title="Instagram"><img src="{{{URL::asset('images/instagram.jpg')}}}" width="32" height="32" alt="Instagram" /></a></td>
                                                    @endif
                                                </tr>
                                            </table>
                                        </td>
                      ...
                      <tr>
                        ...
                        </script> <a href="#" style="color:#6d6e70; text-decoration:none" target="_blank"> Sports Drive </a> All rights reserved. </td>
                      </tr>
                    </table>
                </td>
            </tr>
